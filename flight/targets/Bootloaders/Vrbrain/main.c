/**
 ******************************************************************************
 * @addtogroup VRBrain BootLoader
 * @brief These files contain the code to the VRBrain Bootloader.
 *
 * @{
 * @file       main.c
 * @author     Tau Labs, http://taulabs.org, Copyright (C) 2013
 * @brief      This is the file with the main function of the VRBrain BootLoader

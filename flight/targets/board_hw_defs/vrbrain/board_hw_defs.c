 ...
 * @{
 * @brief Defines board specific static initializers for hardware for the VRBrain.
 *****************************************************************************/
/* 
...
static const struct pios_flash_at45_cfg flash_at45_cfg = {
	.expect_manufacturer = MANUFACTURER_ATMEL,

 ...
 * They are the ground layer just above PiOS. In practice, VRBrain actually starts
 * in the main() function of vrbrain.c
 * @{
 ...
 * @brief      Sets up and runs main VRBrain tasks.

/**
 ******************************************************************************
 * @file       pios_at45_flashfs_logfs_priv.h
 * @author     Tau Labs, http://taulabs.org, Copyright (C) 2012-2013
 * @brief      Driver for talking to AT45DB161 flash chip (and most JEDEC chips)
...
#ifndef PIOS_AT45_FLASHFS_LOGFS_PRIV_H_
#define PIOS_AT45_FLASHFS_LOGFS_PRIV_H_

#include <stdint.h>
#include "pios_flash_at45.h"		/* struct pios_flash_driver */
...
#endif	/* PIOS_AT45_FLASHFS_LOGFS_PRIV_H_ */

...
#ifndef PIOS_MS5611_SPI_PRIV_H
#define PIOS_MS5611_SPI_PRIV_H
...
extern int32_t PIOS_MS5611_Init(uint32_t spi_id, uint32_t slave_num, const struct pios_ms5611_cfg * cfg);

#endif /* PIOS_MS5611_SPI_PRIV_H */
